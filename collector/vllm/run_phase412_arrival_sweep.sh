...
# Phase412 DP2 arrival-sweep trace driver.
#
# Runs one prefix-off DP2 32k3k point with sustained arrivals
# (num_prompts > max_concurrency), vLLM iteration-detail logging, and
