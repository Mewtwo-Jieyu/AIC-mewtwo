...
结论: 指纹门通过。`runtime_lockstep_allowed=true`。

| scenario | metric | sim | target low | target high | passed |
|---|---|---:|---:|---:|---|
| K2.5-tp4ep8dp2-8k2k | mixed_decode_batch_p50 | 46.000 | 34.000 | 52.000 | True |
...
|---|---|---:|
| K2.5-tp4ep8dp2-8k2k | decode+decode | 0.9389 |
| K2.5-tp4ep8dp2-8k2k | mixed_prefill+decode | 0.0002 |
| K2.5-tp4ep8dp2-8k2k | mixed_prefill+mixed_prefill | 0.0607 |
| K2.5-tp4ep8dp2-8k2k | pure_prefill+pure_prefill | 0.0001 |
