...
ARCHITECTURE_TO_MODEL_FAMILY = {
    ...
    # Kimi-K2.5 is an MoE model; treat it as MOE for search space + perf modeling.
    # (Its text_config may reference DeepSeek-style components like MLA, which is
    # covered by separate MLA perf tables, but the overall family here should not
    # trigger DeepSeek-only backend restrictions.)
